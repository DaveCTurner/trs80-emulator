...
public class EqualsExpression extends BooleanExpression {
    ...
    public EqualsExpression(IntegerExpression i1, IntegerExpression i2) {
        super();
        _i1 = i1;
        _i2 = i2;
    }
    ...
    public void visit(SyntaxTreeVisitor v) throws Exception {
        v.enterEqualsExpression(this);
        _i1.visit(v);
        v.visitedLeftOperandOfEqualsExpression(this);
        _i2.visit(v);
        v.visitedRightOperandOfEqualsExpression(this);
        v.leaveEqualsExpression(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EqualsExpression)) { return false; }
