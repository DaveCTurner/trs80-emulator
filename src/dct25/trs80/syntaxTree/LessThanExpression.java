...
public class LessThanExpression extends BooleanExpression {
    ...
    public LessThanExpression(IntegerExpression i1, IntegerExpression i2) {
        super();
        _i1 = i1;
        _i2 = i2;
    }
    ...
    public void visit(SyntaxTreeVisitor v) throws Exception {
        v.enterLessThanExpression(this);
        _i1.visit(v);
        v.visitedLeftOperandOfLessThanExpression(this);
        _i2.visit(v);
        v.visitedRightOperandOfLessThanExpression(this);
        v.leaveLessThanExpression(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LessThanExpression)) { return false; }
        
        LessThanExpression other = (LessThanExpression)o;
        if (null == this._i1) {
