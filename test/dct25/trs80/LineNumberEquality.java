...
public class LineNumberEquality {
    ...
    public void testEqualsBoth10() throws Exception {
        LineNumber ln1 = new LineNumber(new IntegerLiteral(new java.lang.Integer(10)));
        LineNumber ln2 = new LineNumber(new IntegerLiteral(new java.lang.Integer(10)));
    ...
    public void testInequal() throws Exception {
        LineNumber ln1 = new LineNumber(new IntegerLiteral(new java.lang.Integer(10)));
        LineNumber ln2 = new LineNumber(new IntegerLiteral(new java.lang.Integer(20)));
