...
public class IfTestWithEquality {
    ...
    public IfTestWithEquality(int a, int b, int c, int d, boolean outcome) {
        _a = a;
        _b = b;
        _c = c;
        _d = d;
    ...
    public void shouldSkipLine() throws Exception {
        ...
        e.execute(env);
        assertEquals("Should now have cleared screen correct number of times", _outcome ? 1 : 2, env.getScreenClearedCount());
    }
}
